...
public class MainApplication {
    ...
    public ApplicationRunner init() {
        return args -> {
            ...
            System.out.println("-----------------displayBooksByPriceGt35CausingNPlus1-------------------- \n");

            bookstoreService.displayBooksByPriceGt35CausingNPlus1();
            ...
            bookstoreService.displayBooksPriceGt35ViaEntityGraph();
