...
public class BookstoreService {
    ...
    public String titleAndPriceCb() {        
        return dao.fetchTitleAndPriceCb("$", Instant.now());
    }
    
     public List<String> titleAndPriceGt25Cb() {        
        return dao.fetchTitleAndPriceGt25Cb("$", Instant.now());
    }
}
