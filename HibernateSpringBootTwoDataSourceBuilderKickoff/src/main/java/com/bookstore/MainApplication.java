...
public class MainApplication {
    ...
    public ApplicationRunner init() {
        return args -> {                                    
            ...
            Author author1 = authorService.persistAuthor();
            Author author2 = authorBookService.persistAuthor();
            
            System.out.println("\n Saving books (check the 'booksdb' database) ...");
            Book book1 = bookService.persistBook();                        
            Book book2 = authorBookService.persistBook();
            
            authorService.printAuthor(author1.getId());
            bookService.printBook(book1.getId());
            authorBookService.printAuthor(author2.getId());            
            authorBookService.printBook(book2.getId());
        };
    }
}
