...
public class BookstoreController {
    ...
    @GetMapping("/first10")
    public List<AuthorView> fetchAuthorsBooksPublishersReviewersReviews() {

        long start = System.nanoTime();

        List<AuthorView> result = bookstoreService.fetchAuthorsBooksTagsPublishersReviewersReviews();
