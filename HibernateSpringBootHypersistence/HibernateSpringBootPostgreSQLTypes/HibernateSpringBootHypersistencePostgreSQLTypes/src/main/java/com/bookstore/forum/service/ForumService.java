...
public class ForumService {
    ...
    @Transactional(readOnly = true)
    public List<PostDetails> findPublishedAt(String moment) {
        return postDetailsRepository.findPublishedAt(moment);
    }

    @Transactional(readOnly = true)
    public List<PostDetails> findWithAttribute(String key) {
        return postDetailsRepository.findWithAttribute(key);
    }
