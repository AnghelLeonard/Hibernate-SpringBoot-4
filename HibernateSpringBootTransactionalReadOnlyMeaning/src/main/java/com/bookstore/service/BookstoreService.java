...
public class BookstoreService {
    ...
    private void displayInformation(String phase, Author author) {
        ...
        boolean isRO  = entityEntry.isReadOnly();
        boolean rdc = entityEntry.requiresDirtyCheck​(entityEntry);

        System.out.println("Entity entry:" + entityEntry);        
        System.out.println("Status:" + status);
        System.out.println("Read-Only:" + isRO);
        System.out.println("Requires Dirty Check:" + rdc);
