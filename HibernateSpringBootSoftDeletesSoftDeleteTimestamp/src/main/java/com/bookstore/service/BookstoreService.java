...
public class BookstoreService {
    ...
    public void displayAllIncludeDeletedBooks() {
        List<Object[]> books = bookRepository.findAllIncludingDeleted();

        System.out.println("\nAll books including deleted:");
        books.forEach(b -> System.out.println("Book title: " + b[2])); // b[2] is the title
        System.out.println();
    }

    public void displayAllOnlyDeletedBooks() {
        List<Object[]> books = bookRepository.findAllOnlyDeleted();
