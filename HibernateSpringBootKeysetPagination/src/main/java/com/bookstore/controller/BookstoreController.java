...
public class BookstoreController {
    ...
    @GetMapping("/authors/pageable/{id}/{limit}")
    public List<Author> fetchAuthorsPageable(@PathVariable long id, @PathVariable int limit) {

        return bookstoreService.fetchNextPageable(id, limit);
    }
